...
export function generateCertificatePDF(data: CertificateData) {
  ...
  doc.text(data.companyName || "Morabaha MRNA", w / 2, 32, { align: "center" });
  ...
  doc.text(data.employeeName, w / 2, 82, { align: "center" });
  ...
  doc.setFontSize(12);
  doc.setTextColor(107, 114, 128);
  doc.text("has successfully completed the training program", w / 2, 96, { align: "center" });

  // Course title
  doc.setFontSize(20);
  doc.setTextColor(16, 185, 129);
  doc.text(data.courseTitle, w / 2, 110, { align: "center" });
  ...
  doc.text(details, w / 2, 122, { align: "center" });

  // Certificate number
  doc.setFontSize(8);
  doc.setTextColor(156, 163, 175);
  doc.text(`Certificate No: ${data.certificateRef}  |  Employee ID: ${data.employeeId}`, w / 2, 132, { align: "center" });
  ...
  doc.line(w - 120, sigY, w - 50, sigY);

  doc.setFontSize(9);
  doc.setTextColor(107, 114, 128);
  doc.text("HR Director", 85, sigY + 6, { align: "center" });
  doc.text("Training Manager", w - 85, sigY + 6, { align: "center" });

  // Footer
  doc.setFontSize(7);
  doc.setTextColor(209, 213, 219);
  doc.text("This certificate is digitally generated by Taliq HR Platform", w / 2, h - 16, { align: "center" });

  doc.save(`Certificate_${data.certificateRef}.pdf`);
}
